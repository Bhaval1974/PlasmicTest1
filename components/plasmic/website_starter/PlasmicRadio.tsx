...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: g5Jf5D5tSQU8/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__shp31)}>
        <div className={classNames(projectcss.all, sty.freeBox__pmipG)} />
      </div>
      {renderPlasmicSlot({
