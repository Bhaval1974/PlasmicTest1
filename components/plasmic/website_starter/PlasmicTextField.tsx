...
import Label from "../../Label"; // plasmic-import: n6gs8FyDQuQS/component
import TextInput from "../../TextInput"; // plasmic-import: Q0nAHjY2w_bd/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: xADfAaFW2eNq/component
import Description from "../../Description"; // plasmic-import: 2TaZTgPko7Gw/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: VioRPwhcKuFa/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__e2RTj, {
          [sty.freeBoxiconEnd__e2RTjRb9EM]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__e2RTjQuAor]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__e2RTjZWoW8]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__q1S0G, {
            [sty.freeBoxiconStart__q1S0GQuAor]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__q1S0GZWoW8]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oRp6)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__oWeJ9, {
            [sty.freeBoxiconEnd__oWeJ9Rb9EM]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__oWeJ9QuAor]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___5Xfw)}
                role={"img"}
              />
            ),
