...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: dEL-tSO9J_p2/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__vI5P)}
                    label={"Item 3"}
                    value={"item3"}
                  />
