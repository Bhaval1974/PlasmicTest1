...
import MenuPopover from "../../MenuPopover"; // plasmic-import: dEL-tSO9J_p2/component
import MenuItem from "../../MenuItem"; // plasmic-import: hosVWj59j4l4/component
import MenuSection from "../../MenuSection"; // plasmic-import: GahcKQo-QhnG/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: j-0M5dWwSngN/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ybnJr)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__iaaiH)}>
            <ChevronDownIcon
