...
import SliderThumb from "../../SliderThumb"; // plasmic-import: 1vJdOrco6br-/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: ycfnuZERcDKG/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wv8M)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yVWq)}>
        <div
