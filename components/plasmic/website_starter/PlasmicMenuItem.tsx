...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: hosVWj59j4l4/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__x0Hkj)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__zRnie)}>
            <div
              className={classNames(
                projectcss.all,
