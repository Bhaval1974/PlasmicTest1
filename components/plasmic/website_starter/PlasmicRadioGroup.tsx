...
import Radio from "../../Radio"; // plasmic-import: g5Jf5D5tSQU8/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: JpgynPNy6eG0/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__gDdf3)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__vj351)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__grm3Y)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__aybG5)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
