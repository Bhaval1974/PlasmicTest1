...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: 8fRMbAMA_kCb/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lBaK)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zniOv)}>
        <div
