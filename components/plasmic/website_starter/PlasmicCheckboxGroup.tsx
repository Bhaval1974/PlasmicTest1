...
import Checkbox from "../../Checkbox"; // plasmic-import: 6f3Vn1T7gmM3/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: pkOlDGPKNQYS/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__uWQeB)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ekZWl)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__yjrXd)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___9QAvw)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
