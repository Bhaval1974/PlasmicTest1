...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: W0uDiHnWf-ef/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: pGBkY2trBOZc/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox___0PIFn)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__isjru)}
            label={"Open Popover"}
          />
        ),
