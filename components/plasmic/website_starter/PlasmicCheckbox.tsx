...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 6f3Vn1T7gmM3/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 07mMqUA4vhIc/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: E4_7F2HgenDe/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__zogvR)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__eoEZi)}
            role={"img"}
          />
        ) : null}
      </div>
